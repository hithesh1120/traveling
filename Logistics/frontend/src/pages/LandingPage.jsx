...
import {
    RocketOutlined, SafetyOutlined, GlobalOutlined, ThunderboltOutlined,
...
export default function LandingPage() {
    ...
    const roles = [
        { icon: <TeamOutlined style={{ fontSize: 32, color: '#1890ff' }} />, title: 'Admin', desc: 'Full platform control: users, vehicles, zones, analytics, and shipment oversight.' },
