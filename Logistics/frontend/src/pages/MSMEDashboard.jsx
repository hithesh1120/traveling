...
import { Card, Row, Col, Statistic, Button, Table, Tag, Modal, Form, Input, InputNumber, Typography, Space, message, Divider } from 'antd';
    ...
    return (
        <div>
            ...
            <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
                ...
                <Col xs={12} sm={6}>
                    <Card bordered={false}><Statistic title="Active" value={stats.active} prefix={<SendOutlined />} valueStyle={{ color: '#1890ff' }} /></Card>
                </Col>
                <Col xs={12} sm={6}>
            ...
            <Card title="My Shipments" bordered={false}>
                <Table
                    columns={columns}
            ...
            >
                <Form form={form} layout="vertical" onFinish={handleCreate}>
                    <Divider orientation="left" plain>Pickup Details</Divider>
                    <Row gutter={16}>
                        <Col span={24}>
                            <Form.Item name="pickup_address" label="Pickup Address" rules={[{ required: true }]}>
                                <LocationAutocomplete placeholder="Search or enter pickup address" />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item name="pickup_contact" label="Contact Name"><Input /></Form.Item>
                        </Col>
                        <Col span={12}>
                            <Form.Item name="pickup_phone" label="Phone"><Input /></Form.Item>
                        </Col>
                    </Row>
                    ...
                    <Row gutter={16}>
                        <Col span={24}>
                            <Form.Item name="drop_address" label="Drop Address" rules={[{ required: true }]}>
                                <LocationAutocomplete placeholder="Search or enter delivery address" />
                            </Form.Item>
                        </Col>
                        <Col span={12}>
